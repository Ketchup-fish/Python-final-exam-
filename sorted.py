...
t1=sorted([36, 5, -12, 9, -21])
print(t1)
#此外，sorted()函数也是一个高阶函数，它还可以接收一个key函数来实现自定义的排序，
#例如按绝对值大小排序：
t2=sorted([36, 5, -12, 9, -21], key=abs)
print(t2)
...
#keys = [36, 5,  12, 9,  21]
#我们再看一个字符串排序的例子：
t3=sorted(['bob', 'about', 'Zoo', 'Credit'])
print(t3)
...
t4=sorted(['bob', 'about', 'Zoo', 'Credit'], key=str.lower)
print(t4)
#要进行反向排序，不必改动key函数，可以传入第三个参数reverse=True：
t5=sorted(['bob', 'about', 'Zoo', 'Credit'], key=str.lower, reverse=True)
print(t5)
